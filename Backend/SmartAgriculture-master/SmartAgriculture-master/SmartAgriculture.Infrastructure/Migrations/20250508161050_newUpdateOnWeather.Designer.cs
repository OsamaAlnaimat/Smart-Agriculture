...
namespace SmartAgriculture.Infrastructure.Migrations
{
    ...
    [Migration("20250508161050_newUpdateOnWeather")]
    partial class newUpdateOnWeather
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartAgriculture.Domain.Entities.WeatherData", b =>
                {
                    b.HasOne("SmartAgriculture.Domain.Entities.Farm", "Farm")
                        .WithOne("WeatherReadings")
                        .HasForeignKey("SmartAgriculture.Domain.Entities.WeatherData", "FarmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
