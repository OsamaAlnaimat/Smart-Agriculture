...
namespace SmartAgriculture.Infrastructure.Repositories
{
        ...
        IMapper mapper) : IRecommendationRepository
    {
        public async Task<List<Recommendation>?> FetchRecommendationAsync(SoilData soilData, WeatherData weatherData, int fieldId, string userId)
        {
            ...
            //var apiUrl = $"https://ubiquitous-potato-pjr9jqv77w7w3656x-5050.app.github.dev/api/chat?user_id={userId}&top_k=3&score_threshold=0.7";
            ...
            //{
            //    var responseData = JsonConvert.DeserializeObject<RecommendationResponse>(response.Content!);
            ...
            var latestRecommendation = await dbContext.Recommendations
